...
1. Carefully read each question in the pull request homelab-alpha.
...
4. Do not remove the HTML comment tags, as this will break the Pull Request homelab-alpha.
...
- [ ] 🔍 My code follows the [style guidelines](https://github.com/homelab-alpha/homelab-alpha/blob/main/CODE_STYLE_AND_STANDARDS_GUIDES.md) of this project.
...
- [ ] 📚 I have read and understood the [Pull Request Guidelines](https://github.com/homelab-alpha/homelab-alpha/blob/main/CONTRIBUTING.md#pull-requests).
- [ ] ✍️ I have completed the [Author Self-Review Process](https://github.com/homelab-alpha/homelab-alpha/blob/main/.github/review_process_template.md).
