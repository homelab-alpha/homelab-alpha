...
[creating a new security report]:
  https://github.com/homelab-alpha/homelab-alpha/issues/new?assignees=homelab-alpha&labels=security&projects=&template=security_report.yml&title=GitHub+Security+Advisory
